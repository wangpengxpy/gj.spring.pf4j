...
public class GJPluginConfigurationRepository implements ConfigurationRepository {

    private static final Logger log = LoggerFactory.getLogger(GJPluginConfigurationRepository.class);

    public static final String CONFIG_FILE_EXTENSION = ".properties";

    private final Path configRoot;

    public GJPluginConfigurationRepository(Path configRoot) {
